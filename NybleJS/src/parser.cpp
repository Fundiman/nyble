...
std::vector<std::string> Parser::getErrors() const { return errors; }
...
std::unique_ptr<FunDeclNode> Parser::parseFunDecl() {
...
std::unique_ptr<SwitchNode> Parser::parseSwitchStmt() {
...
std::unique_ptr<ThrowNode> Parser::parseThrowStmt() {
...
std::unique_ptr<TryNode> Parser::parseTryStmt() {
...
std::unique_ptr<Expr> Parser::parseMember() {
...
std::unique_ptr<Expr> Parser::parseParenOrArrow() {
